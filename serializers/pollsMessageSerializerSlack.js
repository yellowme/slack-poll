...
const arraySample = require('../utils/arraySample');
const chunkArray = require('../utils/chunkArray');
const emojis = require('../data/emojis.json');

// format emojis with :emoji-name: that slack needs to print an emoji
...
function decoratePollOptions(responses) {
  const groupedResponses = groupBy(responses, 'option');
...
function pollsMessageSerializerSlack(
  poll,
  {
    ...
    icon_emoji = arraySample(iconEmojis),
  }
) {
